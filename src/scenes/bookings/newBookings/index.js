...
import {FooterComponent, SubHeader} from '_atoms';
//css
import Style from './style';

export default function NewOrderBookings(props) {
  return (
    <>
      ...
      <View style={Style.borderBottom}>
        ...
        <View
          ...
          <TouchableOpacity>
            <Text style={Style.newBooking}>New Bookings (5)</Text>
          </TouchableOpacity>

          <TouchableOpacity
            onPress={() => props.navigation.navigate('Arrivals')}>
            <Text style={Style.arrivals}>Arrivals</Text>
          </TouchableOpacity>
        </View>
