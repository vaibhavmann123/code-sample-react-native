...
//For update menuItem Action From invetory
import {
  updateMenuItemRequested,
  fetchMenuItemRequested,
} from '_scenes/inventory/action';

export default function KitchenInventory(props) {
  const dispatch = useDispatch();
  //redux
  // const menuItem = useSelector(state => state.menuItem.menuItemList);
  // // console.log(menuItem, 'menuItemmenuItem');
  ...
  function menuItemRequest() {
    const onSuccess = data => {
      // console.log('KitchenInventory', data);
      data &&
        setMenuItem(() => {
  ...
  return (
    <View style={Style.container}>
      ...
      <KitchenFooter {...props} screen={'inventory'} />
    </View>
  );
}
