...
export default function KitchenFooter(props) {
  // console.log('footer', props, props.tintColor);
  return (
    <View style={style.main}>
      <TouchableOpacity
        onPress={() => props.navigation.navigate('KitchenAction')}>
      ...
      <TouchableOpacity
        onPress={() => props.navigation.navigate('KitchenInventory')}>
        <View style={style.tabSection}>
          <Icon
            icon={'inventory'}
            style={{
      ...
      <TouchableOpacity
        onPress={() => props.navigation.navigate('KitchenProfile')}>
        <View style={style.tabSection}>
          <Icon
            icon={'profile'}
            style={{
